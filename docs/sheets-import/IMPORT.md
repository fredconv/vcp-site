...
Dossier : `docs/sheets-import/` — **9 fichiers CSV**, un par onglet du site.
...
## Étape 3 — Importer les 8 autres onglets

Pour **chaque** fichier restant :
...
1. **+** en bas à gauche → nouvel onglet
2. Renommer l'onglet (nom exact, minuscules)
3. **Fichier** → **Importer** → le CSV correspondant
4. **Remplacer les données à l'emplacement actuel** — séparateur : **Point-virgule**
